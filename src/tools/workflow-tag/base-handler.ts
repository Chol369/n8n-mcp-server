/**
 * Base Workflow Tag Tool Handler
 * 
 * This module provides the base handler for workflow tag management tools.
 */
...
/**
 * Base handler for workflow tag tools
 */
export abstract class WorkflowTagBaseHandler {
  protected apiService: N8nApiService;

  /**
   * Creates a new instance of WorkflowTagBaseHandler
   */
  constructor() {
  ...
  protected async handleExecution(
    ...
    try {
      ...
      return this.formatError(`Error executing workflow tag tool: ${errorMessage}`);
    }
  }
